...
module ConstantTableSaver
  module BaseMethods
    def constant_table(options = {})
      ...
      elsif (ActiveRecord::VERSION::MAJOR == 7 && ActiveRecord::VERSION::MINOR == 2) || ActiveRecord::VERSION::MAJOR == 8
      ...
      if constant_table_options[:name]
        if (ActiveRecord::VERSION::MAJOR == 7 && ActiveRecord::VERSION::MINOR >= 1) || ActiveRecord::VERSION::MAJOR == 8
